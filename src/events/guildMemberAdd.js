...
Kayıt işleminden sonra ${kurallar} kanalına göz atmayı unutmayın. <@&${settings.registerPerm}> Rolündeki Yetkililerimiz Sizinle İlgileneceklerdir
  
Sunucuya [**Sunucu Özel URL**] tarafından davet edildin.
...
\`\`\``});
channel.wsend({ content:`${green} ${member}, **sunucuya katıldı! Davet Eden :** [**Sunucu Özel URL**]`})
return }
...
channel.wsend({ content:`${green} ${member}, \`${usedInvite.inviter.tag}\` davetiyle katıldı! [**Toplam Davet :${total}** ]`})
